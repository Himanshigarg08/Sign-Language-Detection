...
classifier = load_model('C:\\Users\\user\\Desktop\\Final sem Project\\two-way-sign-language-translator\\model.h5')
def give_char():
       import numpy as np
...
op_dest="C:\\Users\\user\\Desktop\\Final sem Project\\two-way-sign-language-translator\\filtered_data\\"
alpha_dest="C:\\Users\\user\\Desktop\\Final sem Project\\two-way-sign-language-translator\\alphabet\\"
...
class StartPage(tk.Frame):
       ...
       def __init__(self, parent, controller):
              ...
              button = tk.Button(self, text="TEXT TO SIGN",font=("Verdana", 10),command=lambda: controller.show_frame(TtoS))
              button.place(x=310,y=80)
              #button.pack(padx=10,pady=10)
              button2 = tk.Button(self, text="SIGN TO TEXT",font=("Verdana", 10),command=lambda: controller.show_frame(StoT))
...
class StoT(tk.Frame):
       ...
       def __init__(self, parent, controller):
              ...
              button2 = tk.Button(self, text="TEXT TO SIGN",command=lambda: controller.show_frame(TtoS))
